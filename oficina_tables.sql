...
CREATE TABLE acc._05 (
	...
	numero_documento BIGINT,
	destino INTEGER,
	valor_venta DEC(10,2),
	icbp DEC(3,2) DEFAULT 0,
	isc DEC(6,2),
	otros_cargos DEC(8,2),
	tipo_moneda VARCHAR REFERENCES TS04(tipo_moneda) ON DELETE SET NULL,
	...
	cuc VARCHAR UNIQUE,
	fecha_cuota1 DATE,
	importe_cuota1 DEC(10,2),
	fecha_cuota2 DATE,
	importe_cuota2 DEC(10,2),
	fecha_cuota3 DATE,
	importe_cuota3 DEC(10,2),
	fecha_cuota4 DATE,
	importe_cuota4 DEC(10,2),
	fecha_cuota5 DATE,
	importe_cuota5 DEC(10,2),
	fecha_cuota6 DATE,
	importe_cuota6 DEC(10,2),
	fecha_cuota7 DATE,
	importe_cuota7 DEC(10,2),
	fecha_cuota8 DATE,
	importe_cuota8 DEC(10,2),
	fecha_cuota9 DATE,
	importe_cuota9 DEC(10,2),
	fecha_cuota10 DATE,
	importe_cuota10 DEC(10,2),
	fecha_cuota11 DATE,
	importe_cuota11 DEC(10,2),
	fecha_cuota12 DATE,
	importe_cuota12 DEC(10,2),
	fecha_cuota13 DATE,
	importe_cuota13 DEC(10,2),
	fecha_cuota14 DATE,
	importe_cuota14 DEC(10,2),
	fecha_cuota15 DATE,
	importe_cuota15 DEC(10,2),
	fecha_cuota16 DATE,
	importe_cuota16 DEC(10,2),
	fecha_cuota17 DATE,
	importe_cuota17 DEC(10,2),
	fecha_cuota18 DATE,
	importe_cuota18 DEC(10,2),
	fecha_cuota19 DATE,
	importe_cuota19 DEC(10,2),
	fecha_cuota20 DATE,
	importe_cuota20 DEC(10,2),
	fecha_cuota21 DATE,
	importe_cuota21 DEC(10,2),
	fecha_cuota22 DATE,
	importe_cuota22 DEC(10,2),
	fecha_cuota23 DATE,
	importe_cuota23 DEC(10,2),
	fecha_cuota24 DATE,
	importe_cuota24 DEC(10,2),
	fecha_cuota25 DATE,
	importe_cuota25 DEC(10,2),
	fecha_cuota26 DATE,
	importe_cuota26 DEC(10,2),
	fecha_cuota27 DATE,
	importe_cuota27 DEC(10,2),
	fecha_cuota28 DATE,
	importe_cuota28 DEC(10,2),
	fecha_cuota29 DATE,
	importe_cuota29 DEC(10,2),
	fecha_cuota30 DATE,
	importe_cuota30 DEC(10,2),
	fecha_cuota31 DATE,
	importe_cuota31 DEC(10,2),
	fecha_cuota32 DATE,
	importe_cuota32 DEC(10,2),
	fecha_cuota33 DATE,
	importe_cuota33 DEC(10,2),
	fecha_cuota34 DATE,
	importe_cuota34 DEC(10,2),
	fecha_cuota35 DATE,
	importe_cuota35 DEC(10,2),
	fecha_cuota36 DATE,
	importe_cuota36 DEC(10,2),
	fecha_cuota37 DATE,
	importe_cuota37 DEC(10,2),
	fecha_cuota38 DATE,
	importe_cuota38 DEC(10,2),
	fecha_cuota39 DATE,
	importe_cuota39 DEC(10,2),
	fecha_cuota40 DATE,
	importe_cuota40 DEC(10,2),
	fecha_cuota41 DATE,
	importe_cuota41 DEC(10,2),
	fecha_cuota42 DATE,
	importe_cuota42 DEC(10,2),
	fecha_cuota43 DATE,
	importe_cuota43 DEC(10,2),
	fecha_cuota44 DATE,
	importe_cuota44 DEC(10,2),
	fecha_cuota45 DATE,
	importe_cuota45 DEC(10,2),
	fecha_cuota46 DATE,
	importe_cuota46 DEC(10,2),
	fecha_cuota47 DATE,
	importe_cuota47 DEC(10,2),
	fecha_cuota48 DATE,
	importe_cuota48 DEC(10,2),
	fecha_cuota49 DATE,
	importe_cuota49 DEC(10,2),
	fecha_cuota50 DATE,
	importe_cuota50 DEC(10,2),
	fecha_cuota51 DATE,
	importe_cuota51 DEC(10,2),
	fecha_cuota52 DATE,
	importe_cuota52 DEC(10,2),
	fecha_cuota53 DATE,
	importe_cuota53 DEC(10,2),
	fecha_cuota54 DATE,
	importe_cuota54 DEC(10,2),
	fecha_cuota55 DATE,
	importe_cuota55 DEC(10,2),
	fecha_cuota56 DATE,
	importe_cuota56 DEC(10,2),
	fecha_cuota57 DATE,
	importe_cuota57 DEC(10,2),
	fecha_cuota58 DATE,
	importe_cuota58 DEC(10,2),
	fecha_cuota59 DATE,
	importe_cuota59 DEC(10,2),
	fecha_cuota60 DATE,
	importe_cuota60 DEC(10,2)
);
...
CREATE TABLE acc._09 (
	id BIGSERIAL PRIMARY KEY,
	entity_id INTEGER REFERENCES entities(entity_id) ON DELETE SET NULL,
	subdiario INTEGER REFERENCES subdiary(codigo) ON DELETE SET NULL DEFAULT 9,
	periodo_tributario INTEGER,
	numero_orden BIGINT UNIQUE,
...
CREATE TABLE acc._10 (
	id BIGSERIAL PRIMARY KEY,
	entity_id INTEGER REFERENCES entities(entity_id) ON DELETE SET NULL,
	subdiario INTEGER REFERENCES subdiary(codigo) ON DELETE SET NULL DEFAULT 10,
	periodo_tributario INTEGER,
