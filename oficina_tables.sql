...
CREATE TABLE acc.spot (codigo INTEGER,descripcion VARCHAR,tasa DEC(3,2));
...
CREATE TABLE acc.exportlog (tipo_operacion INTEGER REFERENCES TS12(tipo_operacion) ON DELETE SET NULL,cui_asociado VARCHAR NOT NULL,codigo_aduana INTEGER REFERENCES ts11(codigo_aduana) ON DELETE SET NULL,periodo_tributario INTEGER,numero_correlativo INTEGER,fecha_numeracion DATE,fecha_embarque DATE,fecha_regularizacion DATE,valor_fob DEC(12,2),peso_neto DEC(12,2))
