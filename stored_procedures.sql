...
CREATE OR REPLACE FUNCTION acc.preliquidacion_general(INTEGER) RETURNS TABLE(ENTIDAD VARCHAR, _100 DEC, _102  DEC, _109 DEC, _106 DEC, _127 DEC, _107 DEC, _120 DEC, _114 DEC, _122 DEC)  LANGUAGE plpgsql AS
$$
BEGIN
	RETURN QUERY
